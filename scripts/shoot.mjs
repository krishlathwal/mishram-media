...
const SHOTS = [
  ...
  /* ── Revision 44 — service landing pages and About ────────────────────
     The sections this pass changed, at the widths the brief asked for. */
  { name: "r44-pfm-hero-390", w: 390, h: 844, scheme: "dark", mobile: true, path: "/services/performance-marketing", selector: "#hero" },
  { name: "r44-pfm-landing-1440", w: 1440, h: 900, scheme: "dark", path: "/services/performance-marketing", selector: "#destination" },
  { name: "r44-pfm-landing-390", w: 390, h: 844, scheme: "dark", mobile: true, path: "/services/performance-marketing", selector: "#destination" },
  { name: "r44-pfm-aud-1024", w: 1024, h: 768, scheme: "dark", path: "/services/performance-marketing", selector: "#who-its-for" },
  { name: "r44-social-hero-390", w: 390, h: 844, scheme: "dark", mobile: true, path: "/services/social-personal-brand-growth", selector: "#hero" },
  { name: "r44-social-field-1440", w: 1440, h: 900, scheme: "dark", path: "/services/social-personal-brand-growth", selector: "#creator-proof" },
  { name: "r44-social-field-768", w: 768, h: 1024, scheme: "dark", path: "/services/social-personal-brand-growth", selector: "#creator-proof" },
  { name: "r44-social-field-390", w: 390, h: 844, scheme: "dark", mobile: true, path: "/services/social-personal-brand-growth", selector: "#creator-proof" },
  { name: "r44-social-aud-1024", w: 1024, h: 768, scheme: "dark", path: "/services/social-personal-brand-growth", selector: "#who-its-for" },
  { name: "r44-inf-hero-390", w: 390, h: 844, scheme: "dark", mobile: true, path: INF, selector: "#hero" },
  { name: "r44-inf-cast-1440", w: 1440, h: 900, scheme: "dark", path: INF, selector: "#creator-proof" },
  { name: "r44-inf-cast-1440-light", w: 1440, h: 900, scheme: "light", path: INF, selector: "#creator-proof" },
  { name: "r44-inf-cast-390", w: 390, h: 844, scheme: "dark", mobile: true, path: INF, selector: "#creator-proof" },
  { name: "r44-inf-aud-1024", w: 1024, h: 768, scheme: "dark", path: INF, selector: "#who-its-for" },
  { name: "r44-web-hero-390", w: 390, h: 844, scheme: "dark", mobile: true, path: WEB, selector: "#hero" },
  { name: "r44-abt-strip-1440", w: 1440, h: 900, scheme: "dark", path: "/about", selector: "#origin" },
  { name: "r44-abt-strip-390", w: 390, h: 844, scheme: "dark", mobile: true, path: "/about", selector: "#origin" },
